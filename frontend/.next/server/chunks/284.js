...
/* harmony import */ var _material_ui_core_Box__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(124);
...
/* harmony import */ var _hooks_ModelAddedFirebase__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(561);
/* harmony import */ var react__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(6689);
/* harmony import */ var react__WEBPACK_IMPORTED_MODULE_5___default = /*#__PURE__*/__webpack_require__.n(react__WEBPACK_IMPORTED_MODULE_5__);
var __webpack_async_dependencies__ = __webpack_handle_async_dependencies__([_hooks_ModelAddedFirebase__WEBPACK_IMPORTED_MODULE_4__]);
_hooks_ModelAddedFirebase__WEBPACK_IMPORTED_MODULE_4__ = (__webpack_async_dependencies__.then ? (await __webpack_async_dependencies__)() : __webpack_async_dependencies__)[0];
...
const ResultView = ({ text  })=>{
    const { modelAddedFunction  } = (0,_hooks_ModelAddedFirebase__WEBPACK_IMPORTED_MODULE_4__/* .modelAddedHook */ .X)();
    ...
    return /*#__PURE__*/ react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx((_material_ui_core_Container__WEBPACK_IMPORTED_MODULE_2___default()), {
        maxWidth: "lg",
        children: /*#__PURE__*/ (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsxs)((_material_ui_core_Box__WEBPACK_IMPORTED_MODULE_1___default()), {
            p: "40px 8px",
            display: "flex",
            flexDirection: "column",
            alignItems: "center",
            children: [
                /*#__PURE__*/ react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx((_material_ui_core_Box__WEBPACK_IMPORTED_MODULE_1___default()), {
                    m: "16px 0 40px",
                    component: "h3",
                    lineHeight: "1.5",
...
/* harmony import */ var _services_apiServices__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(3425);
var __webpack_async_dependencies__ = __webpack_handle_async_dependencies__([_services_apiServices__WEBPACK_IMPORTED_MODULE_5__]);
_services_apiServices__WEBPACK_IMPORTED_MODULE_5__ = (__webpack_async_dependencies__.then ? (await __webpack_async_dependencies__)() : __webpack_async_dependencies__)[0];
...
const SearchView = ({ text , setText , setResultString , setResultData ,  })=>{
    const [dataObjectValue, settDataObjectValue] = react__WEBPACK_IMPORTED_MODULE_1___default().useState({});
    const submitButtonFunction = async ()=>{
        if (Object.values(dataObjectValue).length > 0) {
            const predictPayload = await (0,_services_apiServices__WEBPACK_IMPORTED_MODULE_5__/* .sendDataObjectToApi */ .r)(dataObjectValue);
    ...
    return /*#__PURE__*/ react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx((_material_ui_core_Container__WEBPACK_IMPORTED_MODULE_3___default()), {
        ...
        children: /*#__PURE__*/ (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsxs)((_material_ui_core_Box__WEBPACK_IMPORTED_MODULE_2___default()), {
            ...
            children: [
                ...
                /*#__PURE__*/ react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx(_material_ui_core__WEBPACK_IMPORTED_MODULE_4__.TextareaAutosize, {
...
const Footer = ()=>{
    return /*#__PURE__*/ react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx((_material_ui_core_Box__WEBPACK_IMPORTED_MODULE_1___default()), {
...
let app = firebase_app__WEBPACK_IMPORTED_MODULE_0__.FirebaseApp ? (0,firebase_app__WEBPACK_IMPORTED_MODULE_0__.FirebaseApp)() : (0,firebase_app__WEBPACK_IMPORTED_MODULE_0__.initializeApp)(firebaseConfig);
...
/* harmony import */ var _config_db__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(8812);
...
const modelAddedHook = ()=>{
    const { 0: isModelObject , 1: setIsModelObject  } = (0,react__WEBPACK_IMPORTED_MODULE_0__.useState)(false);
    const { 0: modelObjectData , 1: setModelObjectData  } = (0,react__WEBPACK_IMPORTED_MODULE_0__.useState)([]);
    const { 0: isDataObject , 1: setIsDataObject  } = (0,react__WEBPACK_IMPORTED_MODULE_0__.useState)(false);
    const { 0: dataObjectData , 1: setDataObjectData  } = (0,react__WEBPACK_IMPORTED_MODULE_0__.useState)([]);
...
__webpack_require__.a(module, async (__webpack_handle_async_dependencies__, __webpack_async_result__) => { try {
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "r": () => (/* binding */ sendDataObjectToApi)
/* harmony export */ });
...
const sendDataObjectToApi = (dataObject)=>{
    return new Promise(async (resolve, reject)=>{
        ...
        try {
            ...
            await axios__WEBPACK_IMPORTED_MODULE_0__["default"].post(BASE_URL, Axiosbody, {
                headers: headers
            }).then((resonse)=>{
