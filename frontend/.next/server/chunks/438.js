...
/* harmony import */ var react_dropdown__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(4001);
...
const SearchView = ({ text , setText , setResultString , setResultData ,  })=>{
    ...
    const [modelName, setModelName] = react__WEBPACK_IMPORTED_MODULE_1___default().useState("");
    const options = [
        "rforest",
        "two",
        "three"
    ...
    const submitButtonFunction = async ()=>{
        if (modelName === "") {
            ...
            if (dataObjectValue?.length > 0) {
                const predictPayload = await (0,_services_apiServices__WEBPACK_IMPORTED_MODULE_5__/* .sendDataObjectToApi */ .r)(dataObjectValue, modelName);
    ...
    return /*#__PURE__*/ react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx((_material_ui_core_Container__WEBPACK_IMPORTED_MODULE_3___default()), {
        ...
        children: /*#__PURE__*/ (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsxs)((_material_ui_core_Box__WEBPACK_IMPORTED_MODULE_2___default()), {
            ...
            alignItems: "center",
            children: [
                /*#__PURE__*/ react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx((react_dropdown__WEBPACK_IMPORTED_MODULE_6___default()), {
                    options: options,
...
const sendDataObjectToApi = (dataObject, modelName)=>{
