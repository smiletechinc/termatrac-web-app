...
export declare type ReadType = 'Text' | 'BinaryString' | 'ArrayBuffer' | 'DataURL';
export declare type ReaderMethod = keyof FileReader;
...
export declare type FilePickerReturnTypes = [() => void, {
