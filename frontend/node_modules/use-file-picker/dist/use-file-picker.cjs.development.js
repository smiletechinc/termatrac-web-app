...
var FileSizeValidator = /*#__PURE__*/function () {
  ...
  _proto.validateBeforeParsing = /*#__PURE__*/function () {
    var _validateBeforeParsing = /*#__PURE__*/_asyncToGenerator( /*#__PURE__*/runtime_1.mark(function _callee(config, plainFiles) {
  ...
  _proto.validateAfterParsing = /*#__PURE__*/function () {
    var _validateAfterParsing = /*#__PURE__*/_asyncToGenerator( /*#__PURE__*/runtime_1.mark(function _callee2(_config, _file) {
...
function openFileDialog(accept, multiple, callback, initializeWithCustomAttributes) {
  ...
  if (accept !== '*') inputElement.accept = accept; // Accept multiple files
...
function useFilePicker(_ref) {
  var _ref$accept = _ref.accept,
      ...
      initializeWithCustomParameters = _ref.initializeWithCustomParameters;
    ...
    openFileDialog(fileExtensions, multiple, function (evt) {
      ...
      var validations = VALIDATORS.concat(validators).map(function (validator) {
        return validator.validateBeforeParsing({
          ...
          initializeWithCustomParameters: initializeWithCustomParameters
