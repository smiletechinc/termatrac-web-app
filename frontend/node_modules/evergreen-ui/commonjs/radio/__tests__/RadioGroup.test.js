...
describe('Radio Group', function () {
  ...
  it('should render the radio buttons with HTML name attributes specified', function () {
    (0, _react2.render)( /*#__PURE__*/_react["default"].createElement(_RadioGroup["default"], {
      options: options,
      label: "Permissions",
      name: "RadioInput"
  ...
  it('should render the radio buttons with auto-generated HTML name attributes when name property is empty', function () {
    (0, _react2.render)( /*#__PURE__*/_react["default"].createElement(_RadioGroup["default"], {
      options: options,
      label: "Permissions"
    }));
